        ...
        function refreshSettings() {
            setInterval(function() {
                gameSettings = {
                    ...
                    bonus_prize_for_3_symbol: BONUS_PRIZE[0],
                    bonus_prize_for_4_symbol: BONUS_PRIZE[1],
                    bonus_prize_for_5_symbol: BONUS_PRIZE[2],
                    perc_win_prize_1: PERC_WIN_PRIZE_1,
                    perc_win_prize_2: PERC_WIN_PRIZE_2,
                    perc_win_prize_3: PERC_WIN_PRIZE_3,
