            ...
            aoColumnDefs: [
                {
                    "mRender": function (a, b, data, d) {
                        ...
                        if (data.enabled == 1) {
                            $returnValue += '<li><form method="post" action="country/statusupdate/' + data.code + '" accept-charset="UTF-8" class="delete"><input name="enabled" value="0" type="hidden"><?php echo csrf_field(); ?><button class="btn btn-danger btn-xs" title="Disable Game"><i class="fa fa-toggle-on"></i></button></form></li>'
                        } else {
                            $returnValue += '<li><form method="post" action="country/statusupdate/' + data.code + '" accept-charset="UTF-8" class="delete"><input name="enabled" value="1" type="hidden"><?php echo csrf_field(); ?><button class="btn btn-success btn-xs" title="Enable Game"><i class="fa fa-toggle-off"></i></button></form></li>'
                        }
