...
@section('meta')
    <title>{{ trans('frontend/terms.terms.title') }} - {{ trans('app.meta.short_title') }}</title>

    <meta name="keywords" content="{{ trans('frontend/terms.terms.keywords') }}" />
    <meta name="description" content="{{ trans('frontend/terms.terms.description') }}">
@endsection
        ...
        <div class="container">
            <div class="row mt-lg">
                <div class="col-md-12 center">
                    <h1 class="mb-sm">{{ trans('frontend/terms.terms.title') }}</h1>
                </div>
            </div>
