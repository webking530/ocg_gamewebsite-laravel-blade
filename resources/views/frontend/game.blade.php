                                ...
                                <span class="thumb-info-caption-text">
                                    ...
                                    <div class="col-md-3 text-right">
                                        <p class="align-right p-lg pb-none">
                                            <a class="btn btn-success btn-lg font-size-sm text-uppercase mb-md btn-play" href="{{ route('user.game.manage_session', ['slug' => $game->slug]) }}">PLAY LIVE</a>
                                        </p>
                                    </div>
                                </span>
                            </span>
                        ...
                        <span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom box-shadow-custom mt-xs">
                            <span class="thumb-info-caption">
                                <span class="thumb-info-caption-text">
                                    ...
                                    <div class="col-md-3 text-right">
                                        <p class="align-right p-lg pb-none">
                                            <a class="btn btn-warning btn-lg font-size-sm text-uppercase mb-md btn-play" href="{{ route('home.game.demo', ['slug' => $game->slug]) }}">PLAY DEMO</a>
                                        </p>
                                    </div>
                                </span>
                            </span>
