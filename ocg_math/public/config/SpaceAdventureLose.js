...
module.exports = {
    ...
    symbols: [
        {
            id: 1,
            occurrences: [0, 3, 1, 1, 1],
            paytable: [0, 0, 40, 400, 1000]
        },
        {
            id: 2,
            occurrences: [6, 0, 2, 2, 2],
            paytable: [0, 0, 20, 100, 500]
        },
        {
            id: 3,
            occurrences: [7, 5, 0, 3, 3],
            paytable: [0, 0, 20, 50, 400]
        },
        {
            id: 4,
            occurrences: [0, 5, 3, 3, 3],
            paytable: [0, 0, 20, 50, 400]
        },
        {
            id: 5,
            occurrences: [8, 0, 4, 4, 4],
            paytable: [0, 0, 10, 30, 200]
        },
        {
            id: 6,
            occurrences: [8, 6, 0, 4, 4],
            paytable: [0, 0, 10, 30, 200]
        },
        {
            id: 7,
            occurrences: [0, 7, 5, 5, 5],
            paytable: [0, 0, 10, 20, 100]
        },
        {
            id: 8,
            occurrences: [9, 0, 5, 5, 5],
            paytable: [0, 0, 10, 20, 100]
        }
    ],
    wildSymbol: {
        id: 10,
        occurrences: [0, 0, 0, 1, 1]
    },
    bonusSymbol: {
        id: 9,
        occurrences: [1, 1, 0, 0, 0],
