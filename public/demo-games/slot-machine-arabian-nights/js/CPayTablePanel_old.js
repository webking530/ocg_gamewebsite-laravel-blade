function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text("X"+(5-i),"26px "+FONT_PAYTABLE, "#ffffff");
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[0][4-i],"26px "+FONT_PAYTABLE, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[3][4-i],"26px "+FONT_PAYTABLE, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[6][4-i],"26px "+FONT_PAYTABLE, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[1][4-i],"26px "+FONT_PAYTABLE, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[4][4-i],"26px "+FONT_PAYTABLE, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[2][4-i],"26px "+FONT_PAYTABLE, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        for(i=0;i<3;i++){
            var oText = new createjs.Text(s_aSymbolWin[5][4-i],"26px "+FONT_PAYTABLE, "#ffff00");
            oText.textAlign = "center";
            oText.x = iXPos;
            oText.y = iYPos;
            oText.textBaseline = "alphabetic";
        ...
        _oWildText = new createjs.Text(TEXT_HELP_WILD,"26px "+FONT_PAYTABLE, "#ffff00");
        ...
        var oText = new createjs.Text(TEXT_HELP_BONUS1,"26px "+FONT_PAYTABLE, "#fff");
        oText.textAlign = "center";
        oText.x = 986;
        oText.y = 124;
        oText.lineWidth = 400;
        ...
        var oText2 = new createjs.Text(TEXT_HELP_BONUS2,"26px "+FONT_PAYTABLE, "#fff");
        ...
        var oText = new createjs.Text(TEXT_HELP_FREESPIN,"32px "+FONT_PAYTABLE, "#ffff00");
        oText.textAlign = "center";
