function CPreloader(){
    ...
    this.attachSprites = function(){
       ...
       _oProgressBar.x = 100;
       _oProgressBar.y = CANVAS_HEIGHT - 40;
       _oContainer.addChild(_oProgressBar);
       
       _iMaskWidth = 476;
       _oMaskPreloader = new createjs.Shape();
       _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(100, CANVAS_HEIGHT - 40, 1,30);
       _oContainer.addChild(_oMaskPreloader);
       
       _oProgressBar.mask = _oMaskPreloader;
       _oLoadingText = new createjs.Text("0%","30px "+FONT1, "#fff");
       _oLoadingText.x = 150;
       _oLoadingText.y = CANVAS_HEIGHT - 40;
    ...
    this.refreshLoader = function(iPerc){
        ...
        _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(100, CANVAS_HEIGHT - 40, iNewMaskWidth,30);
    };
