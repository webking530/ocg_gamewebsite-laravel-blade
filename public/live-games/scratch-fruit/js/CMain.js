function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: GAME_PATH + '/sounds/',filename:'sf_loose',loop:false,volume:1, ingamename: 'loose'});
        aSoundsInfo.push({path: GAME_PATH + '/sounds/',filename:'sf_press_but',loop:false,volume:1, ingamename: 'click'});
        aSoundsInfo.push({path: GAME_PATH + '/sounds/',filename:'sf_scratch',loop:false,volume:1, ingamename: 'scratch'});
        aSoundsInfo.push({path: GAME_PATH + '/sounds/',filename:'sf_win',loop:false,volume:1, ingamename: 'win'});
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("fruits_icon",GAME_PATH + "/sprites/fruits_icon.png");
        s_oSpriteLibrary.addSprite("fruits",GAME_PATH + "/sprites/fruits.png");
        s_oSpriteLibrary.addSprite("silver",GAME_PATH + "/sprites/silver.png");
