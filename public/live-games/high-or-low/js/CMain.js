function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: GAME_PATH + '/sounds/',filename:'snap',loop:false,volume:1, ingamename: 'snap'});
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("but_bet",GAME_PATH + "/sprites/but_bet.png");
        s_oSpriteLibrary.addSprite("but_clear_bet",GAME_PATH + "/sprites/but_clear_bet.png");
        s_oSpriteLibrary.addSprite("money_panel",GAME_PATH + "/sprites/money_panel.png");
        s_oSpriteLibrary.addSprite("panel_high_sx",GAME_PATH + "/sprites/panel_high_sx.png");
        s_oSpriteLibrary.addSprite("arrow_high",GAME_PATH + "/sprites/arrow_high.png");
        s_oSpriteLibrary.addSprite("arrow_low",GAME_PATH + "/sprites/arrow_low.png");
        ...
        for(var i=0; i<5; i++){
            iTag = i;
            s_oSpriteLibrary.addSprite("fiche_" +iTag,GAME_PATH + "/sprites/fiche_" +iTag+ ".png");
        }      
