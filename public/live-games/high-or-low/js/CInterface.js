function CInterface(){
    ...
    this._init = function(){                
        ...
        _oMoneyTextBack = new createjs.Text(TEXT_CURRENCY + " " + START_MONEY,"32px "+PRIMARY_FONT, "#000000");
        ...
        _oMoneyText = new createjs.Text(TEXT_CURRENCY + " " + START_MONEY,"32px "+PRIMARY_FONT, "#ffffff");
        _oMoneyText.x = 582;
        _oMoneyText.y = 691;
    ...
    this.refreshMoney = function(iValue){
        _oMoneyTextBack.text = TEXT_CURRENCY + " " + iValue;
        _oMoneyText.text = TEXT_CURRENCY + " " + iValue;
    };
