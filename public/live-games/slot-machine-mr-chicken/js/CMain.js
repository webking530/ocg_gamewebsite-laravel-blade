function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        if(navigator.userAgent.indexOf("Opera")>0 || navigator.userAgent.indexOf("OPR")>0){
			...
			createjs.Sound.registerSound(GAME_PATH + "/sounds/choose_chicken.ogg", "choose_chicken");
			...
			createjs.Sound.registerSound(GAME_PATH + "/sounds/reveal_egg.ogg", "reveal_egg");
		}else{
			...
			createjs.Sound.registerSound(GAME_PATH + "/sounds/choose_chicken.mp3", "choose_chicken");
			...
			createjs.Sound.registerSound(GAME_PATH + "/sounds/reveal_egg.mp3", "reveal_egg");
		}
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("chicken",GAME_PATH + "/sprites/chicken.png");
        s_oSpriteLibrary.addSprite("hit_area_chicken",GAME_PATH + "/sprites/hit_area_chicken.png");
        s_oSpriteLibrary.addSprite("egg",GAME_PATH + "/sprites/egg.png");
