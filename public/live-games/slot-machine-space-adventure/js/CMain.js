function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: './sounds/',filename:'choose_ufo',loop:false,volume:1, ingamename: 'choose_ufo'});
        aSoundsInfo.push({path: './sounds/',filename:'press_hold',loop:false,volume:1, ingamename: 'press_hold'});
        aSoundsInfo.push({path: './sounds/',filename:'reveal_alien',loop:false,volume:1, ingamename: 'reveal_alien'});
