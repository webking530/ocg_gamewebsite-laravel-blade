function CPreloader(){
    ...
    this._init = function(){
       ...
       s_oSpriteLibrary.addSprite("preloader_bar",GAME_PATH + "/sprites/preloader_bar.png");
    ...
    this.attachSprites = function(){
       ...
       _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(511, CANVAS_HEIGHT - 170, 1,30);
    ...
    this.refreshLoader = function(iPerc){
        ...
        _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(511, CANVAS_HEIGHT - 170, iNewMaskWidth,30);
    };
