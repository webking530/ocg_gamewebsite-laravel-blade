function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: GAME_PATH + '/sounds/',filename:'win',loop:true,volume:1, ingamename: 'win'});
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("bg_doubleup",GAME_PATH + "/sprites/bg_doubleup.jpg");
