function CInterface(iMoney,iBet){
	...
	_oMoneyText = new createjs.Text(iMoney.toFixed(2)+TEXT_CURRENCY,"29px "+FONT2, "#ffde00");
        _oMoneyText.x = 584;
        _oMoneyText.y = CANVAS_HEIGHT - 63;
        ...
        _oBetOneBut = new CTextButton(1040,720,oSprite,TEXT_BET_ONE,FONT1,"#ffffff",23,s_oStage);
        _oBetOneBut.addEventListener(ON_MOUSE_UP, this._onButBetOneRelease, this);
        
        _oBetMaxBut = new CTextButton(1190,720,oSprite,TEXT_MAX_BET,FONT1,"#ffffff",23,s_oStage);
        _oBetMaxBut.addEventListener(ON_MOUSE_UP, this._onButBetMaxRelease, this);
        
        _oDealBut = new CTextButton(1340,720,oSprite,TEXT_DEAL,FONT1,"#ffffff",30,s_oStage);
