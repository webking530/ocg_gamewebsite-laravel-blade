function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        _oInfoBut = new CTextButton(320 + (oSprite.width/2),CANVAS_HEIGHT - (oSprite.height/2)- 4,oSprite,TEXT_INFO,FONT_GAME,"#ffffff",32);        
        _oInfoBut.addEventListener(ON_MOUSE_UP, this._onInfo, this);
        
        
        oSprite = s_oSpriteLibrary.getSprite('but_lines_bg');
        _oAddLineBut = new CTextButton(490 + (oSprite.width/2),CANVAS_HEIGHT - (oSprite.height/2)- 4,oSprite,TEXT_LINES,FONT_GAME,"#ffffff",32);
        _oAddLineBut.addEventListener(ON_MOUSE_UP, this._onAddLine, this);
        
        oSprite = s_oSpriteLibrary.getSprite('coin_but');
        _oBetCoinBut = new CTextButton(678 + (oSprite.width/2),CANVAS_HEIGHT - (oSprite.height/2)- 4,oSprite,TEXT_COIN,FONT_GAME,"#ffffff",32);
        _oBetCoinBut.addEventListener(ON_MOUSE_UP, this._onBet, this);
        
        oSprite = s_oSpriteLibrary.getSprite('but_maxbet_bg');
        _oMaxBetBut = new CTextButton(866 + (oSprite.width/2),CANVAS_HEIGHT - (oSprite.height/2)- 4,oSprite,TEXT_MAX_BET,FONT_GAME,"#ffffff",32);
        _oMaxBetBut.addEventListener(ON_MOUSE_UP, this._onMaxBet, this);
		
	_oMoneyText = new createjs.Text(TEXT_MONEY +"\n"+iMoney.toFixed(2)+TEXT_CURRENCY,"34px "+FONT_GAME, "#ffde00");
        _oMoneyText.x = 450;
        _oMoneyText.y = 46;
        ...
        _oNumLinesText = new createjs.Text(NUM_PAYLINES ,"24px "+FONT_GAME, "#ffde00");
        _oNumLinesText.x =  584;
        _oNumLinesText.y = CANVAS_HEIGHT - 77;
        ...
        _oCoinText = new createjs.Text(iCurBet.toFixed(2) ,"24px "+FONT_GAME, "#ffde00");
        _oCoinText.x =  776;
        _oCoinText.y = CANVAS_HEIGHT - 77;
        ...
        _oTotalBetText = new createjs.Text(TEXT_BET +": "+iTotBet.toFixed(2),"24px "+FONT_GAME, "#ffde00");
        _oTotalBetText.x = 980;
        _oTotalBetText.y = CANVAS_HEIGHT - 77;
